...
qualifiedTwoLegs = FILTER possibleTwoLegs
                   BY f1::FlightDate >= '2007-06-01'
                   AND f1::FlightDate < '2008-06-01';

delays = FOREACH qualifiedTwoLegs
         GENERATE $5+$11 AS delay:double;

d = GROUP delays ALL;

result = FOREACH d
         GENERATE COUNT_STAR(delays) AS count:int,
                  AVG(d.delays) AS average:double;

STORE result INTO 's3://cs6240-shao/pigout-joinfirst-version2';